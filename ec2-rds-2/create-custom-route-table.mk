...
.PHONY: create-custom-route-table
create-custom-route-table: init-variables-for-create-custom-route-table
	make --no-print-directory output-custom-route-table-if-created > /dev/null 2>&1 \
	...
	make --no-print-directory output-custom-route-table-if-created

.PHONY: output-custom-route-table-if-created
output-custom-route-table-if-created: init-variables-for-create-custom-route-table
	...
	@[ -n "$(CUSTOM_ROUTE_TABLE)" ] && ( echo '$(CUSTOM_ROUTE_TABLE)' | jq > $(CUSTOM_ROUTE_TABLE_JSON_PATH) )

.PHONY: init-variables-for-create-custom-route-table
init-variables-for-create-custom-route-table:
...
.PHONY: delete-custom-route-table
delete-custom-route-table: init-variables-for-create-custom-route-table
