...
# {
#   "custom_route_table": {
#     "custom_route_table_id": "rtb-xxxxxx"
#   }
# }
# ----
################################################################################
...
readonly route_table_id=$(aws ec2 describe-route-tables --filters Name=vpc-id,Values=${VPC_ID} --filter Name=association.main,Values=false | jq '.RouteTables[].RouteTableId')
